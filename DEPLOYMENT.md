...
sudo service unicorn_terceroAPP <start|stop|restart>
sudo service sidekiq_terceroAPP <start|stop>
```
...
```
/home/deployer/apps/terceroAPP/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_terceroAPP restart
sudo service sidekiq_terceroAPP stop
sudo service sidekiq_terceroAPP start
```
